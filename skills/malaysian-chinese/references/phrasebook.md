# Malaysian Chinese Phrasebook

Deeper vocabulary reference. Everything here is Level 2–3 register unless noted.

## Everyday exclamations & fillers

| Expression | Meaning | Example |
|---|---|---|
| walao / walao eh | disbelief, "no way" | "Walao eh, RM18 for kopi peng?!" |
| aiya / aiyo | mild dismay, "oh no" | "Aiyo, forgot to bring wallet lah" |
| fuyoh / wah | impressed | "Fuyoh, new car ah?" |
| alamak | "oh no" (Malay) | "Alamak, jam already" |
| cehh / cheh | dismissive, "that's it?" | "Cheh, I thought what big news" |
| hor / horr | drawn out = "I told you so" | "Horrr, see lah, kena scold liao" |
...
|---|---|---|
| makan | Malay | eat — "Jom makan", "makan already?" |
| tapau / da bao | Cantonese 打包 (via Malay spelling) | takeaway food |
| belanja | Malay | treat someone — "I belanja you lah, promotion mah" |
| yum cha | Cantonese 饮茶 | hang out over drinks (NOT dim sum in MY usage) |
| lepak | Malay | chill / hang around doing nothing |
| kacau | Malay | disturb — "Don't kacau me, doing work" |
| tahan | Malay | endure — "Cannot tahan the heat" |
| gostan | English "go astern" | reverse (a car) |
| pau / sapu | dialect/Malay | grab everything — "He sapu all the food" |
| potong stim | Malay | kill the mood, buzzkill |
| fetch | MY English | give someone a ride — "I fetch you from LRT" |
| outstation | MY English | out of town for work |
| gostan, pump, saman | MY road life | reverse, petrol station, traffic fine |

## Describing people & things

| Expression | Origin | Meaning |
|---|---|---|
| syok | Malay | awesome, satisfying — "Syok wei this laksa" |
| paiseh | Hokkien 歹势 | embarrassed — "Paiseh, late again" |
| kiasu | Hokkien 惊输 | afraid of losing out |
| cincai | Hokkien 凊彩 | whatever / anyhow — "Cincai lah, anything also can" |
| lansi | Cantonese 懒散→躝屍 | arrogant, cocky |
| sombong | Malay | snobbish |
| leng zai / leng lui | Cantonese 靓仔/靓女 | handsome guy / pretty girl |
| ho liao | Hokkien 好料 | the good stuff, delicious |
| sui | Hokkien 媠 | pretty |
| heng | Hokkien 幸 | lucky — "Heng ah, almost kena saman" |
| kaypoh | Hokkien 鸡婆 | busybody |
| action | MY English | showing off — "So action one this fella" |
| terror | MY English | impressively skilled — "Wah your Excel damn terror" |
| half past six | MY English | half-hearted, shoddy |
| banana | MY Chinese slang | Chinese person who can't speak/read Chinese |
| ang moh / gwai lou | Hokkien / Cantonese | white foreigner |
| sibeh | Hokkien 死爸 | very/damn — "sibeh 累" (damn tired), "sibeh hot today" |
| kancheong | Cantonese 紧张 | nervous, panicky — "kancheong spider" = someone who panics over everything |
| ham sap (lou) | Cantonese 咸湿(佬) | pervert(ed) — "careful that ham sap lou" |
...
- **cham** = coffee + tea mixed
- **teh tarik** = pulled milk tea (the national drink)
- 100 plus, sky juice (= plain water, older slang), "water" often means any drink: "You want what water?"

## Example dialogues

**Making plans (Level 2):**
> A: "Weh, tonight yum cha or not?"
> B: "Can also. Where?"
> A: "Old Town lor, near your house one."
> B: "Okok, 9 like that I fetch you."

**Complaining (Level 2–3):**
> "Walao the jam just now, one hour only move two kilometer. Then reach already mana tau no parking somemore. Die lah next time I just Grab."

**Aunty at reunion dinner (Level 3):**
> "Aiyo, so big already ah! Got girlfriend or not? Your cousin hor, last year buy house liao wor. You leh? Aiya no rush lah, eat more, so thin!"

**Level 1 (light) — marketing copy:**
> "Balik kampung this CNY? Tapau our pineapple tarts for the family — confirm the aunties will approve."

## Malaysian Mandarin (华语) quick reference

When writing Chinese for a Malaysian audience:

| MY Mandarin | Standard | Meaning |
|---|---|---|
| 酱 / 酱子 | 这样 | like this/that — "酱也可以哦" |
| 做莫 | 为什么/干嘛 | why / what for |
| 几好下 | 挺好的 | quite good ("几+adj+下" pattern) |
| 够力 | 厉害/离谱 | intense, "that's nuts" |
| 巴刹 | 菜市场 | wet market (pasar) |
| 拜一/拜二…礼拜 | 周一/周二…周日 | days of week |
| 做工 | 上班 | go to work |
| 冲凉 | 洗澡 | shower |
| 水草 | 吸管 | drinking straw |
| 大耳窿 | 放高利贷的 | loan shark |
| 脚车 | 自行车 | bicycle |
| 罗里 | 卡车 | lorry/truck |
...
1. **Dialect/Malay → English (classic Manglish):**
   "Don't be so kancheong lah, sap sap sui only this thing."

2. **Dialect/English → Mandarin (rojak 华语):** slang words embedded in a Mandarin sentence —
   - "那个人很 lansi 的" (that guy is so arrogant)
   - "明天 yumcha 咯?" (yum cha tomorrow?)
   - "我现在 sibeh 累" (I'm damn tired now)
   - "Cincai 啦，我都可以" (whatever lah, anything works for me)
   - "我们 gab 钱买礼物" (let's pool money for the gift)

3. **Romanized Mandarin → English (the "wo mei you qian" register):** dropping pinyin-ish Mandarin phrases into English for comedic/relatable effect, popularized by Twitter/Facebook humor threads —
   - "Cannot go out leh, wo mei you qian" (我没有钱 — I'm broke)
   - "Ask him for help? Mei wen ti one" (没问题 — no problem)
