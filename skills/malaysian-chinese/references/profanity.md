# Profanity & Rough Language Reference

Documented for authenticity and comprehension — knowing these is part of understanding real Malaysian Chinese speech. **Read the usage rules at the bottom before ever producing any of this.**

## Tier 1 — Mild (safe among friends, PG)

| Expression | Origin | Meaning / vibe |
|---|---|---|
| walao / walao eh | Hokkien 我老(的) | "no way / oh my god" — everyday disbelief |
| aiyo / aiya / alamak | mixed | mild dismay |
| siao / siao liao | Hokkien 痟 | crazy — "You siao ah?" (are you nuts?) |
| sot / sot sot dei | Cantonese 傻 | a bit cuckoo, short-circuited |
| bodoh | Malay | stupid — playground-level insult |
| kanasai | Hokkien 干若屎 | "like shit" — "this weather kanasai" |
...
| tiu / diu | Cantonese 屌 | the Cantonese f-word, used as standalone exclamation |
| celaka | Malay | "damn it / cursed" |

## Tier 3 — Extreme (genuinely offensive — comprehension only, do not produce)

Listed so the model *understands* them when users say them, not for output:

- **cibai / cb** (Hokkien 膣屄) — the c-word; the most common heavy Hokkien vulgarity, often abbreviated "cb" in text
- **kan ni na / knn** (Hokkien) — "f— your mother"; sometimes extended "knnbccb"
- **pukimak** (Malay) — extremely vulgar "your mother's —"
- **diu lei lo mo / dllm** (Cantonese 屌你老母) — "f— your mother"
- **mahai** (Cantonese 媽閪) — heavy vulgarity, common in angry KL Cantonese

## Usage rules (hard guardrails)
